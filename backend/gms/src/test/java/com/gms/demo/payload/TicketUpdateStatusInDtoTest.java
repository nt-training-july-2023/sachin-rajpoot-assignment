...
public class TicketUpdateStatusInDtoTest {
	CommentDto commentDto = new CommentDto();
	   private TicketUpdateStatusInDto ticketUpdateStatusInDto1 = new TicketUpdateStatusInDto(Status.OPEN, commentDto);
	    private TicketUpdateStatusInDto ticketUpdateStatusInDto2 = new TicketUpdateStatusInDto(Status.CLOSED, commentDto);
	    ...
	    public void testGettersAndSetters() {
	        ...
	        ticketUpdateStatusInDto1.setStatus(Status.CLOSED);
	        assertEquals(Status.CLOSED, ticketUpdateStatusInDto1.getStatus());
	    ...
	    public void testToString() {
	        assertEquals("TicketUpdateStatusInDto [status=" +ticketUpdateStatusInDto1.getStatus()  + ", comment=" + ticketUpdateStatusInDto1.getComment() + "]", ticketUpdateStatusInDto1.toString());
	    }
