...
//	@NotEmpty
	...
	public TicketDto(final Integer ticketId, @NotEmpty final String title, @NotEmpty final String description,
			final Date createdOn, final Date lastUpdatedOn,  final Status status,
			 final TicketType ticketType, final DepartmentDto departmentDto, final MemberDto memberDto) {
		this.ticketId = ticketId;
		this.title = title;
		this.description = description;
		this.createdOn = createdOn;
